...
public class BoardConfig {
  ...
  @Bean
  public BoardDto boardDto1() {//<bean class="BoardDto1" id="boardDto1"/>
  ...
  @Bean
  public BoardDto boardDto2() {//<bean class="BoardDto1" id="boardDto1"/>
    return new BoardDto(2,"제목2","작성자2");
  }
  
  
  @Bean
  public BoardDto boardDto3() {//<bean class="BoardDto1" id="boardDto1"/>
    return new BoardDto(3,"제목3","작성자3");
  }
  
  
  
  //타입이 일치하는게 하나뿐이라서 이름은 중요하지 않다.
  @Bean
